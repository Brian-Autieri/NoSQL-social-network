const addDateSuffix = (date) => {
  ...
  const lastCharachter = dateString.charAt(dateString.length - 1);

  if (lastCharachter === "1" && dateString !== "11") {
    dateString = `${dateString}st`;
  } else if (lastCharachter === "2" && dateString !== "12") {
    dateString = `${dateString}nd`;
  } else if (lastCharachter === "3" && dateString !== "13") {
